...
{
    public class LoginAttemptFilter : ActionFilterAttribute // giriş işlemlerinin başarısızlık loglarının tutulması için filtreleme oluşturulmuştur ve userController'a verilecektir.
    {
